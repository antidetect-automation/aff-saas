...
| # | Asset | Status | Where |
|---|--------|--------|--------|
| 1 | Playwright starter kit | **Shipping this upgrade** | `kits/playwright-mlx-starter/` |
| 2 | Postman no-code kit | **Shipping** | `kits/postman/` + `/guides/postman-mlx/` |
| 3 | WebGL leak checker | **Shipping on github.io** (not pages.dev) | `/tools/webgl-check/` |
| 4 | Proxy pack formatter | **Shipping** | `/tools/proxy-format/` |
| 5 | Telegram intent onboarding | Done | `@antidetect_automation_bot` |
| 6 | Source-aware deep links | Done | `?start=aa_*` |
| 7 | Troubleshooting / content factory | Partial | `content/` drafts + FAQ |
| 8 | Use-case landings | **Shipping** | `/use-cases/*` |
| 9 | Hub SSOT | Done | `aff-saas` → `*.github.io` |
| 10 | Evergreen refresh Actions | **Enabling** (workflow scope now OK) | `.github/workflows/` |
